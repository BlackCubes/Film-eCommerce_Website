...
if (isset($_GET['isd']) /*&& validate_url('http://localhost/FilmIndustry/eCommerce/products/index.php?isd=' . $_GET['isd'] . '&department=' . $_GET['department'] . '&format=' . $_GET['format'])*/) {
    ...
    if (mysqli_num_rows($r) == 1) {
        ...
        while ($director = mysqli_fetch_array($r_director, MYSQLI_ASSOC)) {
            echo '<tr><td class="cast-crew-image--product-view"><a href="#"><img alt="' . $director['director_fn'] . ' ' . $director['director_mn'] . ' ' . $director['director_ln'] . '" title="' . $director['director_fn'] . ' ' . $director['director_mn'] . ' ' . $director['director_ln'] . '" src="/FilmIndustry/eCommerce/img/' . $director['director_img'] . '"></a></td><td class="director-name--product-view"><a href="#">' . $director['director_fn'] . ' ' . $director['director_mn'] . ' ' . $director['director_ln'] . '</a></td></tr>';
        }
        ...
        while ($writer = mysqli_fetch_array($r_writer, MYSQLI_ASSOC)) {
            echo '<tr><td class="cast-crew-image--product-view"><a href="#"><img alt="' . $writer['writer_fn'] . ' ' . $writer['writer_mn'] . ' ' . $writer['writer_ln'] . '" title="' . $writer['writer_fn'] . ' ' . $writer['writer_mn'] . ' ' . $writer['writer_ln'] . '" src="/FilmIndustry/eCommerce/img/' . $writer['writer_img'] . '"></a></td><td class="writer-name--product-view"><a href="#">' . $writer['writer_fn'] . ' ' . $writer['writer_mn'] . ' ' . $writer['writer_ln'] . '</a></td></tr>';
        }
        ...
        while ($actor = mysqli_fetch_array($r_actor, MYSQLI_ASSOC)) {
            echo '<tr><td class="cast-crew-image--product-view"><a href="#"><img alt="' . $actor['actor_fn'] . ' ' . $actor['actor_mn'] . ' ' . $actor['actor_ln'] . '" title="' . $actor['actor_fn'] . ' ' . $actor['actor_mn'] . ' ' . $actor['actor_ln'] . '" src="/FilmIndustry/eCommerce/img/' . $actor['actor_img'] . '"></a></td><td class="actor-name--product-view"><a href="#">' . $actor['actor_fn'] . ' ' . $actor['actor_mn'] . ' ' . $actor['actor_ln'] . '</a></td></tr>';
        }
        ...
        while ($producer = mysqli_fetch_array($r_producer, MYSQLI_ASSOC)) {
            echo '<tr><td class="cast-crew-image--product-view"><a href="#"><img alt="' . $producer['producer_fn'] . ' ' . $producer['producer_mn'] . ' ' . $director['producer_ln'] . '" title="' . $producer['producer_fn'] . ' ' . $producer['producer_mn'] . ' ' . $producer['producer_ln'] . '" src="/FilmIndustry/eCommerce/img/' . $producer['producer_img'] . '"></a></td class="producer-name--product-view"><td><a href="#">' . $producer['producer_fn'] . ' ' . $producer['producer_mn'] . ' ' . $producer['producer_ln'] . '</a></td></tr>';
        }
        ...
        while ($dp = mysqli_fetch_array($r_dp, MYSQLI_ASSOC)) {
            echo '<tr><td class="cast-crew-image--product-view"><a href="#"><img alt="' . $dp['dp_fn'] . ' ' . $dp['dp_mn'] . ' ' . $dp['dp_ln'] . '" title="' . $dp['dp_fn'] . ' ' . $dp['dp_mn'] . ' ' . $dp['dp_ln'] . '" src="/FilmIndustry/eCommerce/img/' . $dp['dp_img'] . '"></a></td><td class="cinematographer-name--product-view"><a href="#">' . $dp['dp_fn'] . ' ' . $dp['dp_mn'] . ' ' . $dp['dp_ln'] . '</a></td></tr>';
        }
        ...
        while ($studio = mysqli_fetch_array($r_studio, MYSQLI_ASSOC)) {
            echo '<tr><td class="cast-crew-image--product-view"><a href="#"><img alt="' . $studio['studio_name'] . '" title="' . $studio['studio_name'] . '" src="/FilmIndustry/eCommerce/img/' . $studio['studio_img'] . '"></a></td><td class="studio-name--product-view"><a href="#">' . $studio['studio_name'] . '</a></td></tr>';
        }
