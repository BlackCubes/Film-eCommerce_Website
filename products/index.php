...
if (isset($_GET['isd']) /*&& validate_url('http://localhost/FilmIndustry/eCommerce/products/index.php?isd=' . $_GET['isd'] . '&department=' . $_GET['department'] . '&format=' . $_GET['format'])*/) {
    ...
    if (mysqli_num_rows($r) == 1) {
        ...
        echo '<div class="container--product-view"><div class="breadcrumb">' . $breadcrumb->build(array(ucfirst(strtolower($department_title)) => strtolower($department_title) . '/index.php', $product['product_name'] => '')) . '</div><div class="main-info--product-view"><div class="image--product-view"><img alt="' . $product['product_name'] . '" src="/FilmIndustry/uploads/products/' . $product['product_image_1'] . '"></div><div class="product-info-option"><div class="product-title--info-option"><h1>' . $product['product_name'] . '</h1></div><div class="product-edition--info-option"><h3>' . $product['product_edition'] . '</h3></div><div class="cast-crew-format--info-option"><span class="cast-crew"></span><span class="format-title">Format: </span><span class="format-type">' . $product['product_format'] . '</span></div><hr></div><div class="cart-wishlist-container"><form method="post" action="/FilmIndustry/eCommerce/cart/index.php?action=add&isd=' . $product_isd . '" id="cartCard"><div class="cart-quantity"><label for="cartQuantity">Qty: </label><select name="quantity" id="cartQuantity">';
