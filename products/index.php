...
if (isset($_GET['isd']) /*&& validate_url('http://localhost/FilmIndustry/eCommerce/products/index.php?isd=' . $_GET['isd'] . '&department=' . $_GET['department'] . '&format=' . $_GET['format'])*/) {
    ...
    if (mysqli_num_rows($r) == 1) {
        ...
        echo '</td></tr><tr><td class="sku-title">SKU</td><td class="sku-type">' . $product['product_sku'] . '</td></tr><tr><td class="isd-title">ISD</td><td class="isd-type">' . $product['product_isd'] . '</td></tr></tbody></table></div></div><div class="product-specs-info--product-view"><div class="product-specs-title--product-view"><h2>Product Specs</h2></div><table class="product-specs-list--product-view"><thead><tr><th class="spec-format-type-title">Format Type</th><th class="spec-video-desc-title">Video Description</th><th class="spec-audio-desc-title">Audio Description</th><th class="spec-sub-desc-title">Subtitle Description</th></tr></thead><tbody><tr><td class="spec-format-type">' . $product['product_spec_format_type'] . '</td><td class="product-video-desc">' . $product['product_video_desc'] . '</td><td class="product-audio-desc">' . $product['product_audio_desc'] . '</td><td class="product-sub-desc">' . $product['product_sub_desc'] . '</td></tr></tbody></table></div>';
