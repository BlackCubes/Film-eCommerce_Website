...
if (isset($_GET['isd']) /*&& validate_url('http://localhost/FilmIndustry/eCommerce/products/index.php?isd=' . $_GET['isd'] . '&department=' . $_GET['department'] . '&format=' . $_GET['format'])*/) {
    ...
    if (mysqli_num_rows($r) == 1) {
        ...
        echo '<span class="cast-crew-format-separator">|</span><span class="format-title">Format: </span><span class="format-type">' . $product['product_format'] . '</span><span class="cast-crew-format-separator">|</span><span class="department-title">Department: </span><span class="department-type">' . $product['product_department'] . '</span></div><hr><div class="additional-table-container--info-option"><table class="additional-options-title"><thead><tr><th class="additional-format-title">Additional 4K options</th><th class="secondary-color">Edition</th><th class="secondary-color">Discs</th><th class="secondary-color">Price</th></tr></thead></table><table class="additional-options-description"><tbody><tr><td>' . $product['product_format'] . '<br>(' . $product['product_media_date'] . ')</td><td>' . $product['product_format'] . '</td><td>' . $product['product_discs'] . '</td><td class="product-price">$' . $product['product_price'] . '</td></tr></tbody></table></div></div><div class="cart-wishlist-container"><form method="post" action="/FilmIndustry/eCommerce/cart/index.php?action=add&isd=' . $product_isd . '" id="cartCard"><div class="cart-quantity"><label for="cartQuantity">Qty: </label><select name="quantity" id="cartQuantity">';
