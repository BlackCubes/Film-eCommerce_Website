...
if (isset($_SESSION['cart_item'])) {
    ...
    echo '<div class="subtotal-cart--cart-view"><p><span class="subtotal-title-amount--cart-view">Subtotal (' . $item_count . '):</span><span class="subtotal-display--cart-view"> $' . $subtotal_price . '</span></p></div></div></div></div>';
