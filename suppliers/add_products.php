...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ((preg_match('/^[A-Z\p{L}]{1}(.[A-Z]{1}.)?([a-z\p{L}]+)?$/u', $_POST['directors_first_name']) && preg_match('/^[A-Z\p{L}]{1}([a-z\p{L}]{1}[A-Z\p{L}]{1})?([\']{1}[A-Z\p{L}]{1})?[a-z\p{L}]+([-]{1}[A-Z\p{L}]{1}[a-z\p{L}]+)?( Jr.)?$/u', $_POST['directors_last_name'])) || (preg_match('/^([A-Z\p{L}]{1}(.[A-Z]{1}.)?([a-z\p{L}]+)?[, ]{2})*[A-Z\p{L}]{1}(.[A-Z]{1}.)?([a-z\p{L}]+)?$/u', $_POST['directors_first_name']) && preg_match('/^([A-Z\p{L}]{1}([a-z\p{L}]{1}[A-Z\p{L}]{1})?([\']{1}[A-Z\p{L}]{1})?[a-z\p{L}]+([-]{1}[A-Z\p{L}]{1}[a-z\p{L}]+)?( Jr.)?[, ]{2})*[A-Z\p{L}]{1}([a-z\p{L}]{1}[A-Z\p{L}]{1})?([\']{1}[A-Z\p{L}]{1})?[a-z\p{L}]+([-]{1}[A-Z\p{L}]{1}[a-z\p{L}]+)?( Jr.)?$/u', $_POST['directors_last_name']))) {
    ...
    if ((preg_match('/^[A-Z\p{L}]{1}(.[A-Z]{1}.)?([a-z\p{L}]+)?$/u', $_POST['actors_first_name']) && preg_match('/^[A-Z\p{L}]{1}([a-z\p{L}]{1}[A-Z\p{L}]{1})?([\']{1}[A-Z\p{L}]{1})?[a-z\p{L}]+([-]{1}[A-Z\p{L}]{1}[a-z\p{L}]+)?( Jr.)?$/u', $_POST['actors_last_name'])) || (preg_match('/^([A-Z\p{L}]{1}(.[A-Z]{1}.)?([a-z\p{L}]+)?[, ]{2})*[A-Z\p{L}]{1}(.[A-Z]{1}.)?([a-z\p{L}]+)?$/u', $_POST['actors_first_name']) && preg_match('/^([A-Z\p{L}]{1}([a-z\p{L}]{1}[A-Z\p{L}]{1})?([\']{1}[A-Z\p{L}]{1})?[a-z\p{L}]+([-]{1}[A-Z\p{L}]{1}[a-z\p{L}]+)?( Jr.)?[, ]{2})*[A-Z\p{L}]{1}([a-z\p{L}]{1}[A-Z\p{L}]{1})?([\']{1}[A-Z\p{L}]{1})?[a-z\p{L}]+([-]{1}[A-Z\p{L}]{1}[a-z\p{L}]+)?( Jr.)?$/u', $_POST['actors_last_name']))) {
    ...
    if ((preg_match('/^[A-Z\p{L}]{1}(.[A-Z]{1}.)?([a-z\p{L}]+)?$/u', $_POST['producers_first_name']) && preg_match('/^[A-Z\p{L}]{1}([a-z\p{L}]{1}[A-Z\p{L}]{1})?([\']{1}[A-Z\p{L}]{1})?[a-z\p{L}]+([-]{1}[A-Z\p{L}]{1}[a-z\p{L}]+)?( Jr.)?$/u', $_POST['producers_last_name'])) || (preg_match('/^([A-Z\p{L}]{1}(.[A-Z]{1}.)?([a-z\p{L}]+)?[, ]{2})*[A-Z\p{L}]{1}(.[A-Z]{1}.)?([a-z\p{L}]+)?$/u', $_POST['producers_first_name']) && preg_match('/^([A-Z\p{L}]{1}([a-z\p{L}]{1}[A-Z\p{L}]{1})?([\']{1}[A-Z\p{L}]{1})?[a-z\p{L}]+([-]{1}[A-Z\p{L}]{1}[a-z\p{L}]+)?( Jr.)?[, ]{2})*[A-Z\p{L}]{1}([a-z\p{L}]{1}[A-Z\p{L}]{1})?([\']{1}[A-Z\p{L}]{1})?[a-z\p{L}]+([-]{1}[A-Z\p{L}]{1}[a-z\p{L}]+)?( Jr.)?$/u', $_POST['producers_last_name']))) {
    ...
    if ((preg_match('/^[A-Z\p{L}]{1}(.[A-Z]{1}.)?([a-z\p{L}]+)?$/u', $_POST['writers_first_name']) && preg_match('/^[A-Z\p{L}]{1}([a-z\p{L}]{1}[A-Z\p{L}]{1})?([\']{1}[A-Z\p{L}]{1})?[a-z\p{L}]+([-]{1}[A-Z\p{L}]{1}[a-z\p{L}]+)?( Jr.)?$/u', $_POST['writers_last_name'])) || (preg_match('/^([A-Z\p{L}]{1}(.[A-Z]{1}.)?([a-z\p{L}]+)?[, ]{2})*[A-Z\p{L}]{1}(.[A-Z]{1}.)?([a-z\p{L}]+)?$/u', $_POST['writers_first_name']) && preg_match('/^([A-Z\p{L}]{1}([a-z\p{L}]{1}[A-Z\p{L}]{1})?([\']{1}[A-Z\p{L}]{1})?[a-z\p{L}]+([-]{1}[A-Z\p{L}]{1}[a-z\p{L}]+)?( Jr.)?[, ]{2})*[A-Z\p{L}]{1}([a-z\p{L}]{1}[A-Z\p{L}]{1})?([\']{1}[A-Z\p{L}]{1})?[a-z\p{L}]+([-]{1}[A-Z\p{L}]{1}[a-z\p{L}]+)?( Jr.)?$/u', $_POST['writers_last_name']))) {
    ...
    if ((preg_match('/^[A-Z\p{L}]{1}(.[A-Z]{1}.)?([a-z\p{L}]+)?$/u', $_POST['dp_first_name']) && preg_match('/^[A-Z\p{L}]{1}([a-z\p{L}]{1}[A-Z\p{L}]{1})?([\']{1}[A-Z\p{L}]{1})?[a-z\p{L}]+([-]{1}[A-Z\p{L}]{1}[a-z\p{L}]+)?( Jr.)?$/u', $_POST['dp_last_name'])) || (preg_match('/^([A-Z\p{L}]{1}(.[A-Z]{1}.)?([a-z\p{L}]+)?[, ]{2})*[A-Z\p{L}]{1}(.[A-Z]{1}.)?([a-z\p{L}]+)?$/u', $_POST['dp_first_name']) && preg_match('/^([A-Z\p{L}]{1}([a-z\p{L}]{1}[A-Z\p{L}]{1})?([\']{1}[A-Z\p{L}]{1})?[a-z\p{L}]+([-]{1}[A-Z\p{L}]{1}[a-z\p{L}]+)?( Jr.)?[, ]{2})*[A-Z\p{L}]{1}([a-z\p{L}]{1}[A-Z\p{L}]{1})?([\']{1}[A-Z\p{L}]{1})?[a-z\p{L}]+([-]{1}[A-Z\p{L}]{1}[a-z\p{L}]+)?( Jr.)?$/u', $_POST['dp_last_name']))) {
    ...
    if ($product_name && $department && $format && $theatre_date && $rating && $genres_id && $description && $directors_id && $actors_id && $producers_id && $writers_id && $dps_id && $studios_id && $runtime && $format_type && $video_desc && $audio_desc && $sub_desc && $price && $stock && $sku) {
        ...
        $q2 = "INSERT INTO specs (spec_format_type, video_desc, audio_desc, subtitles_desc) VALUES ('{$format_type}', '{$video_desc}', '{$audio_desc}', '{$sub_desc}')";
        ...
        if (mysqli_affected_rows($dbc) == 1) {
            ...
            for ($i = 0; $i < count($genres_id); $i++) {
                $q2 = "INSERT INTO products_genres (product_id, genre_id) VALUES (({$product_id}), " . $genres_id[$i] . ")";
                $r2 = mysqli_query($dbc, $q2) or trigger_error("Query: $q2\n<br>MySQL Error " . mysqli_error($dbc));
            }

            for ($i = 0; $i < count($directors_id); $i++) {
                $q3 = "INSERT INTO products_directors (product_id, director_id) VALUES (({$product_id}), " . $directors_id[$i] . ")";
                $r3 = mysqli_query($dbc, $q3) or trigger_error("Query: $q3\n<br>MySQL Error: " . mysqli_error($dbc));
            }

            for ($i = 0; $i < count($actors_id); $i++) {
                $q4 = "INSERT INTO products_actors (product_id, actor_id) VALUES (({$product_id}), " . $actors_id[$i] . ")";
                $r4 = mysqli_query($dbc, $q4) or trigger_error("Query: $q4\n<br>MySQL Error: " . mysqli_error($dbc));
            }

            for ($i = 0; $i < count($producers_id); $i++) {
                $q5 = "INSERT INTO products_producers (product_id, producer_id) VALUES (({$product_id}), " . $producers_id[$i] . ")";
                $r5 = mysqli_query($dbc, $q5) or trigger_error("Query: $q5\n<br>MySQL Error " . mysqli_error($dbc));
            }

            for ($i = 0; $i < count($writers_id); $i++) {
                $q6 = "INSERT INTO products_writers (product_id, writer_id) VALUES (({$product_id}), " . $writers_id[$i] . ")";
                $r6 = mysqli_query($dbc, $q6) or trigger_error("Query: $q6\n<br>MySQL Error " . mysqli_error($dbc));
            }

            for ($i = 0; $i < count($dps_id); $i++) {
                $q7 = "INSERT INTO products_dps (product_id, dp_id) VALUES (({$product_id}), " . $dps_id[$i] . ")";
                $r7 = mysqli_query($dbc, $q7) or trigger_error("Query: $q7\n<br>MySQL Error " . mysqli_error($dbc));
            }

            for ($i = 0; $i < count($studios_id); $i++) {
                $q8 = "INSERT INTO products_studios (product_id, studio_id) VALUES (({$product_id}), " . $studios_id[$i] . ")";
