...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ((preg_match('/^[A-Z]{1}[a-z]+$/', $_POST['directors_first_name']) && preg_match('/^[A-Z]{1}([a-z]{1}[A-Z]{1})?[a-z]+$/', $_POST['directors_last_name'])) || (preg_match('/^([A-Z]{1}[a-z]+[, ]{2})*[A-Z]{1}[a-z]+$/', $_POST['directors_first_name']) && preg_match('/^([A-Z]{1}([a-z]{1}[A-Z]{1})?[a-z]+[, ]{2})*[A-Z]{1}([a-z]{1}[A-Z]{1})?[a-z]+$/', $_POST['directors_last_name']))) {
    ...
    if ((preg_match('/^[A-Z]{1}[a-z]+$/', $_POST['actors_first_name']) && preg_match('/^[A-Z]{1}([a-z]{1}[A-Z]{1})?[a-z]+$/', $_POST['actors_last_name'])) || (preg_match('/^([A-Z]{1}[a-z]+[, ]{2})*[A-Z]{1}[a-z]+$/', $_POST['actors_first_name']) && preg_match('/^([A-Z]{1}([a-z]{1}[A-Z]{1})?[a-z]+[, ]{2})*[A-Z]{1}([a-z]{1}[A-Z]{1})?[a-z]+$/', $_POST['actors_last_name']))) {
    ...
    if ((preg_match('/^[A-Z]{1}[a-z]+$/', $_POST['producers_first_name']) && preg_match('/^[A-Z]{1}([a-z]{1}[A-Z]{1})?[a-z]+$/', $_POST['producers_last_name'])) || (preg_match('/^([A-Z]{1}[a-z]+[, ]{2})*[A-Z]{1}[a-z]+$/', $_POST['producers_first_name']) && preg_match('/^([A-Z]{1}([a-z]{1}[A-Z]{1})?[a-z]+[, ]{2})*[A-Z]{1}([a-z]{1}[A-Z]{1})?[a-z]+$/', $_POST['producers_last_name']))) {
    ...
    if ((preg_match('/^[A-Z]{1}[a-z]+$/', $_POST['writers_first_name']) && preg_match('/^[A-Z]{1}([a-z]{1}[A-Z]{1})?[a-z]+$/', $_POST['writers_last_name'])) || (preg_match('/^([A-Z]{1}[a-z]+[, ]{2})*[A-Z]{1}[a-z]+$/', $_POST['writers_first_name']) && preg_match('/^([A-Z]{1}([a-z]{1}[A-Z]{1})?[a-z]+[, ]{2})*[A-Z]{1}([a-z]{1}[A-Z]{1})?[a-z]+$/', $_POST['writers_last_name']))) {
    ...
    if ((preg_match('/^[A-Z]{1}[a-z]+$/', $_POST['dp_first_name']) && preg_match('/^[A-Z]{1}([a-z]{1}[A-Z]{1})?[a-z]+$/', $_POST['dp_last_name'])) || (preg_match('/^([A-Z]{1}[a-z]+[, ]{2})*[A-Z]{1}[a-z]+$/', $_POST['dp_first_name']) && preg_match('/^([A-Z]{1}([a-z]{1}[A-Z]{1})?[a-z]+[, ]{2})*[A-Z]{1}([a-z]{1}[A-Z]{1})?[a-z]+$/', $_POST['dp_last_name']))) {
