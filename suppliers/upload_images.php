    ...
    <table style="width:90%">
        ...
        <tbody>
            ...
            while ($products = mysqli_fetch_array($r, MYSQLI_ASSOC)) {
                ...
                echo '<tr><td>' . $products['name'] . '</td><td>' . $products['sku'] . '</td><td style="width:400px"><img src="' . $image_1 . '" alt="First Image" width="100" height="138"><p><input type="file" name="file_1"></p></td><td style="width:400px"><img src="' . $image_2 . '" alt="Second Image" width="100" height="138"><p><input type="file" name="file_2"></p></td></tr>';
