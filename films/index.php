...
<div class="container">
    ...
    <div class="main-product">
        ...
        while ($product = mysqli_fetch_array($r, MYSQLI_ASSOC)) {
            echo '<div class="container-product"><div class="product-image"><img src="/FilmIndustry/uploads/products/' . $product['image_1'] .'" style="max-width:280px;max-height:280px"; alt="#"></div><div class="product-name">' . $product['name'] . '</div><div class="product-price">$' . $product['unit_price'] . '</div></div>';
        }
