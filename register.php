...
<form action="register.php" method="post">
    <fieldset>
        ...
        <p><strong>Phone Number</strong> <input type="text" name="phone_num" size="15" maxlength="15" value="<?php if (isset($trimmed['phone_num'])) echo $trimmed['phone_num']; ?>"><small>(Optional, but may be used to assist delivery)</small></p>
    </fieldset>
