...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($e && $p) {
        ...
        $q = "SELECT id, first_name, email, pass, phone_num FROM users WHERE email='$e' AND verify_code IS NULL";
        ...
        if (@mysqli_num_rows($r) == 1) {
            ...
            list($user_id, $first_name, $email, $pass, $phone_num) = mysqli_fetch_array($r, MYSQLI_NUM);
