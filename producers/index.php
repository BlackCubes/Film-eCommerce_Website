...
if ($pages > 1) {
    ...
    if ($current_page != 1) {
        echo '<a href="/FilmIndustry/eCommerce/producers/index.php?s=' . ($start - $display) . '&p=' . $pages . '&sort=' . $sort . '">Previous</a>';
    }
    ...
    if ($current_page != $pages) {
        echo '<a href="/FilmIndustry/eCommerce/producers/index.php?s=' . ($start + $display) .'&p=' . $pages . '&sort=' . $sort .'">Next</a>';
    }
