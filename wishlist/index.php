    ...
    if (mysqli_num_rows($r) == 1) {
        ...
        switch ($wishlist_action) {
            ...
            case "add":
                ...
                $q = "INSERT INTO wishlists (product_id, product_department, product_format, quantity, date_created, date_modified, user_id) VALUES ({$product_id}, '" . $product_department[0] . "', '" . $product_format[0] . "', {$_POST['quantity']}, NOW(), NOW(), {$_SESSION['id']})";
